...
export default function SalesHistoryPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Sales History - Vape Inventory</title>
        <meta name="description" content="View previous sales and transaction details" />
      </Helmet>
      ...
      <div className="h-full flex flex-col min-h-0 gpu overflow-x-hidden">
        <PageHeader
          label="Sales"
          title="Sales History"
          description="View previous sales and transaction details."
          actions={
