...
export default function InventoryPage() {
  ...
  return (
    <>
      <Helmet>
        <title>Inventory - Vape Inventory</title>
        <meta name="description" content="Monitor and adjust your inventory levels" />
      </Helmet>
      ...
      <div className="h-full flex flex-col min-h-0 gpu overflow-x-hidden">
        <PageHeader
          ...
          description="Monitor and adjust your inventory levels."
          actions={
        ...
        <div className="grid grid-cols-2 gap-5 mb-6 shrink-0 sm:grid-cols-4 animate-fade-in-up">
          <button
            ...
            className={`rounded-2xl border bg-white p-7 text-left shadow-sm transition tap-target card-hover gpu ${inventoryFilter === "all"
          ...
          <button
            type="button"
            onClick={() => handleInventoryFilter("all")}
            className="rounded-2xl border border-zinc-200 bg-white p-7 text-left shadow-sm transition hover:border-zinc-400 hover:bg-zinc-50 tap-target card-hover gpu"
          >
          ...
          <button
            ...
            className={`rounded-2xl border bg-white p-7 text-left shadow-sm transition tap-target card-hover gpu ${inventoryFilter === "low"
          ...
          <button
            ...
            className={`rounded-2xl border bg-white p-7 text-left shadow-sm transition tap-target card-hover gpu ${inventoryFilter === "out"
